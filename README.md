...
and delivers alerts to Slack.

## Contents
- `nordgreen-monitor-workflow.json` — the working n8n workflow (import directly)
- `nordgreen_monitor.py` — standalone Python reference version
- `submission-note.md` — full write-up covering approach, AI usage,
